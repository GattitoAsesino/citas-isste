...
import Interpreter.TimeFormatExpression;
/**
 *
 * @author crist
 */
public class Formato_Citas {
    ...
    public static void obtenerHorasDisponibles(Connection conn, JComboBox<String> horaComboBox, 
    String fecha, int idMedico) {
    TimeFormatExpression timeValidator = new TimeFormatExpression("HH:mm");
    try {
