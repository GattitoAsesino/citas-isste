...
private void toggleAutenticacion() {
    ...
    if (usarAutenticacionTradicional) {
        JOptionPane.showMessageDialog(this, "Modo: Autenticación Tradicional");
    } else {
    ...
    private void initComponents() {
        ...
        toggleAuthButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                toggleAuthButtonActionPerformed(evt);
            }
        });
    ...
    if (credencial1.isEmpty() || credencial2.isEmpty()) {
    ...
    if (usarAutenticacionTradicional) {
        autenticacion = new SesionSQL(conn);
    } else {
        autenticacion = new AutenticacionGoogle();
    }

    // Crear el Adapter
    AutenticacionAdapter adapter = new AutenticacionAdapter(autenticacion);

    // Intentar autenticar
    Usuario usuario = adapter.autenticar(credencial1, credencial2);
