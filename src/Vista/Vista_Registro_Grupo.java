 ...
 * @author crist
 */
public class Vista_Registro_Grupo extends javax.swing.JFrame {
     ...
     */
    public Vista_Registro_Grupo(Connection Cx) {
        initComponents();
        conn = Cx;
        this.grupoUsuarios = new GrupoUsuarios(conn);
    }
    ...
    private void initComponents() {
        ...
        agreUsua = new javax.swing.JLabel();
        ...
        agreUsua.setText("Agregar usuario");
        agreUsua.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                agreUsuaMouseClicked(evt);
            }
        });
        ...
        jPanel7.setBackground(new java.awt.Color(88, 153, 153));
        ...
        Registrarse.setText("Registrar grupo");
        ...
        jPanel1.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, 1100, 630));
    ...
    private void registrarGrupoUsuarios() {
    if (grupoUsuarios.estaVacio()) {
        JOptionPane.showMessageDialog(this, "No hay usuarios para registrar", "Error", JOptionPane.ERROR_MESSAGE);
        return;
    }

    boolean registrado = grupoUsuarios.registrarUsuarios();
    if (registrado) {
        JOptionPane.showMessageDialog(this, "Todos los usuarios fueron registrados exitosamente", "Éxito", JOptionPane.INFORMATION_MESSAGE);
    } else {
        JOptionPane.showMessageDialog(this, "Error al registrar los usuarios", "Error", JOptionPane.ERROR_MESSAGE);
    }
}
    ...
    private void agreUsuaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_agreUsuaMouseClicked
        // TODO add your handling code here:
    ...
    if (Nombre.isEmpty() || correoText.isEmpty() || contraseñaText.isEmpty() || confirmarContraseñaText.isEmpty() || 
        apellidoMaternoText.isEmpty() || apellidoPaternoText.isEmpty()) {
        JOptionPane.showMessageDialog(this, "Rellena todos los campos", "Error", JOptionPane.ERROR_MESSAGE);
        return;
    }
    ...
    JOptionPane.showMessageDialog(this, "Usuario agregado al grupo correctamente", "Éxito", JOptionPane.INFORMATION_MESSAGE);
    rfc.setText("");
        curp.setText("");
        nombre.setText("");
        correo.setText("");
    ...
    }//GEN-LAST:event_agreUsuaMouseClicked
    ...
    private javax.swing.JLabel agreUsua;
