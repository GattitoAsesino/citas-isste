...
<<<<<<< HEAD
    ...
    if (Nombre.isEmpty() || correoText.isEmpty() || contraseñaText.isEmpty() || 
        confirmarContraseñaText.isEmpty() || apellidoMaternoText.isEmpty() || 
        apellidoPaternoText.isEmpty()) {
        ...
        try {
            if (RegistrarUsuario.registrar(conn, usuario)) {
                System.out.println("Usuario original registrado.");

                // Clonar el usuario
                Usuario usuarioClonado = usuario.clone();
                System.out.println("Usuario clonado creado con ID: " + usuarioClonado.getId());

                // Registrar el usuario clonado en la base de datos
                if (RegistrarUsuario.registrar(conn, usuarioClonado)) {
                    System.out.println("Usuario clonado registrado correctamente.");
                } else {
