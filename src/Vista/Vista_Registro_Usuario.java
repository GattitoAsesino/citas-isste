...
public class Vista_Registro_Usuario extends javax.swing.JFrame {
    ...
    private void RegistrarseMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_RegistrarseMouseClicked
        ...
        IRegistroUsuario real = new RegistroUsuarioReal(conn);
        IRegistroUsuario proxy = new RegistroUsuarioProxy(real);
        // Usamos el patrón Command
        RegistrarUsuarioComando comando = new RegistrarUsuarioComando(usuario, real);
        InvocadorRegistro invocador = new InvocadorRegistro();
        invocador.setCommand(comando);
        invocador.ejecutarRegistro();
        
        
            try {
            if (proxy.registrar(usuario)) {
    ...
    private void confirmar_contraseñaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmar_contraseñaActionPerformed
        ...
        String apellidoMaternoText = apellido_m.getText();
        String apellidoPaternoText = apellido_p.getText();    
        if (Nombre.isEmpty() || correoText.isEmpty() || contraseñaText.isEmpty() ||
            confirmarContraseñaText.isEmpty() || apellidoMaternoText.isEmpty() || apellidoPaternoText.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Rellena todos los campos", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        if(validarCurp(curpText) && validarRFC(rfcText)){
