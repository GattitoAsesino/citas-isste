...
import Vista_Doctor.CitaContexto;
import Vista_Doctor.EstadoDisponible;
import Vista_Doctor.EstadoReservada;
...
public class AgendarCita extends javax.swing.JFrame {
    ...
    // Obtener lista de horas disponibles de tu método actual
  List<String> horas = Formato_Citas.obtenerHorasDisponiblesLista(conn, fecha, idMedico);
List<String> horasReservadas = Formato_Citas.obtenerHorasReservadasLista(conn, fecha, idMedico);


    CitaContexto contexto = new CitaContexto();
    
    for (String h : horas) {
        if (horasReservadas.contains(h)) {
            contexto.setEstado(new EstadoReservada());
        } else {
            contexto.setEstado(new EstadoDisponible());
        }
        contexto.mostrar(Hora, h);
    }
