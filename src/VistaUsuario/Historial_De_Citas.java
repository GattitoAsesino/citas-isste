...
import Modelo.ControladorVista_Historial_De_Citas;
 ...
 * @author crist
 */
public class Historial_De_Citas extends javax.swing.JFrame {
    private Connection conn;
    private Usuario user;
    /**
     * Creates new form Historial_De_Citas
     */
    public Historial_De_Citas(Usuario user, Connection conn) {
        initComponents();
        this.conn = conn;
        this.user = user;
        ControladorVista_Historial_De_Citas.mostrarDatos(conn, citasAgendadas, user.getId());
    }
    ...
    private void initComponents() {
        ...
        citasAgendadas = new javax.swing.JTable();
        ...
        citasAgendadas.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
        citasAgendadas.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "Id_Cita", "Id_Paciente", "Nombre_Paciente", "Fecha_Agendada", "Hora_Agendada", "Doctor", "Fecha_Cita", "Hora_Cita"
            }
        ));
        jScrollPane1.setViewportView(citasAgendadas);
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 100, 1200, 700));
    ...
    private javax.swing.JTable citasAgendadas;
